...
and the y-axis is the proportion[^proportion] of datasets that are tabular (CSV).
For example, if there were 300 datasets on a portal in June 2011 and 250 were CSV,
