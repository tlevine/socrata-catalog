...
The other formats appear to be external links. They're sometimes available in a few
formats, as specified in the `distribution` field of `/data.json`, but one of them
gets chosen for the `format` field.
