...
that included [derived views]() (map, charts, &c.).
This still includes [federated data]() (duplicates),
however, and I haven't come up with a great way of determining which direction
the federation is in beyond just downloading the data.
...
### Federation
I need to find a good way of determining the federation direction. Obvious approaches
include reading it from the home page of the portals and following the links in the
`/data.json` file.
