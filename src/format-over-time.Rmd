...
include reading the federation information from home pages of the portals
or by following the links in the `/data.json` file.

### Cutoff at 1000?
I find it highly suspicious that multiple portals have exactly 1000
datasets. These portals ()
all federate `explore.data.gov`, which has quite a few datasets, and the JSON
