...
print(p0)
```
Public domain is actually the only license; if a dataset "license" isn't
listed as public domain, it isn't licensed at all.
...
print(p8)
```
## Why be explicit that traffic surveys are in the public domain
The /unitedstates project explains the merits of being explicit about
